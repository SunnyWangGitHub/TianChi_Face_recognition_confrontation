...
def main():
    ...
    IR_50_model_1.load_state_dict(
        torch.load('/notebooks/Workspace/tmp/pycharm_project_314/TianChi/Face_recognition/irse/model/backbone_ir50_asia.pth'))
    IR_50_model_1.eval().to(device)
    print('load IR_50 successfully')

    IR_152_model_1 = IR_152([112,112])
    IR_152_model_1.load_state_dict(
        torch.load('/notebooks/Workspace/tmp/pycharm_project_314/TianChi/Face_recognition/irse/model/Backbone_IR_152_Epoch_112_Batch_2547328_Time_2019-07-13-02-59_checkpoint.pth'))
    ...
    for path in tqdm(paths):
        ...
        sample_dir = '/notebooks/Workspace/tmp/pycharm_project_314/TianChi/output_img2/'
